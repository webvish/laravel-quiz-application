      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
              <a href="{{ url('student/dashboard')}}" class="nav-link nav-toggle {{ request()->routeIs('dashboard') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ url('student/exam')}}" class="nav-link nav-toggle {{ request()->routeIs('exam') ? 'active' : '' }}">
