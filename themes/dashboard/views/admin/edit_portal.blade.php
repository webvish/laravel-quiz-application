                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" required="required" value="{{ $portal_info->email}}" name="email" placeholder="Enter email" class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    {{ csrf_field()}}
                                    <input type="text" required="required" value="{{ $portal_info->mobile_no}}" name="mobile_no" placeholder="Enter mobile number" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="15">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
