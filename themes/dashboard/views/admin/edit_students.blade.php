                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" value="{{ $students->email}}" required="required" name="email" placeholder="Enter name" class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    {{ csrf_field()}}
                                    <input type="text" value="{{ $students->mobile_no}}" required="required" name="mobile_no" placeholder="Enter mobile-no" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="15">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
